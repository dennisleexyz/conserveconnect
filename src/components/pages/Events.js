...
function Events(props) {
  return (
    <div className='eventCard'>
        <div className='eventImage' style={{backgroundImage: `url(${props.imageSrc})`}}></div>
        <div className='eventDesc'>
            ...
            <div className='capInfo'>
              ...
              <p>{props.attending}/{props.capacity}</p>
            </div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pellentesque leo eu ex finibus, in scelerisque erat commodo. Nullam eget ullamcorper purus. Nam vitae convallis dui. consectetur adipiscing elit. Sed pellentesque leo eu ex finibus, in scelerisque erat commodo. Nullam eget ullamcorper purus. Nam vitae convallis dui.</p>
